...
echo"<tr><th><b>Bill_Id</b></th><th><b>Patient ID</b></th><th><b>Patient Name</b></th><th><b>Doctor charge</b></th><th><b>Room charge</b></th><th><b>Total Bill</b></th></tr>";
while($data=pg_fetch_row($res))
{
			$add=$data[4]+$data[3];
			echo"<tr><td>$data[0]</td><td>$data[1]</td><td>$data[2]</td><td>$data[3]</td><td>$data[4]</td><td>$add</td></tr>";
			echo"<br>";
}
?>
