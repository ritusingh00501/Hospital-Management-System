...
$res=pg_query($con,"insert into doctor_login (user_id,password) values ('$user_id','$password')");
$count=pg_num_rows($res);
if (!$res) {
   echo "Error: " . pg_last_error($dbconn);
   } else {
echo "<h1><center>Doctor registered successfully!</center></h1>";
	echo"<center><a href=doctor_login.html><h3>GOTO Login</h3></a></center>";
     //echo "<h1>User Added successfully!";
     }
