     ...
     <!--- <div class="col-md-6">
        <div class="card">
          <div class="card-body">
            ...
            <a href="doctor_screen.html" class="btn btn-primary">View</a>
          </div>
        </div>
      </div>
      <div class="col-md-6">
        <div class="card">
          <div class="card-body">
            ...
            <a href="patient.php" class="btn btn-primary">View</a>
          </div>
        </div>
  </div>--->
<div class="col-md-6">
...
<div class="col-md-6">
        <div class="card">
          <div class="card-body">
            ...
            <a href="p_book_app.html" class="btn btn-primary">Book Appointment</a>
          </div>
        </div>
  </div>
<div class="col-md-6">
	    ...
	    <a href="check_bill1.php" class="btn btn-primary">Check Bill</a>
...
<div class="col-md-6">
        <div class="card">
          <div class="card-body">
            <h5 class="card-title">Book Appointment for test</h5>
            <p class="card-text">View and manage all of your Appointment.</p>
	    <a href="path_view.php" class="btn btn-primary">View Tests</a>
            <!---<a href="payment1.php" class="btn btn-primary">View</a>--->
          </div>
        </div>
  </div>
