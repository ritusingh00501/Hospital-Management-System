      ...
      <div class="col-md-6">
        <div class="card">
          <div class="card-body">
            ...
            <a href="patient03.php" class="btn btn-primary">View</a>
          </div>
        </div>
  </div>
<!---<div class="col-md-6">
...
<div class="col-md-6">
        <div class="card">
          <div class="card-body">
            ...
            <a href="check_app1.php" class="btn btn-primary">View</a>
          </div>
        </div>
  </div>
<div class="col-md-6">
	    ...
	    <a href="add_bill.html" class="btn btn-primary">Generate Bill For Patient</a>
            <a href="payment12.php" class="btn btn-primary">View</a>
          </div>
        </div>
  </div>
</div>
